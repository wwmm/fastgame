...
void save_preset(ApplicationWindow* self, const std::string& name, const std::filesystem::path& directory) {
  ...
  root.put("disk.mounting-path", ui::disk::get_mounting_path(self->disk));
...
void load_preset(ApplicationWindow* self, const std::string& name) {
  ...
  ui::disk::set_mounting_path(self->disk,
                              root.get<std::string>("disk.mounting-path", ui::disk::get_mounting_path(self->disk)));
